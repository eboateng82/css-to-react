  ...
  <div className="header">
	...
	<div className="mystyle" >
	    <ul Style={{listStyleType: none, margin: '0', padding:'0'}, {float : right}}>
			...
			<li><Link className="sidebar" to="/">Equipment</Link></li>
     ...
     <div className="main">
	   <h2>Equipment</h2>
		...
		<h3>Harness</h3>
		<img className="alignright" src="assets/img/emptyharness.jpg" alt="A rock climbing harness" />
		...
		<h3>Shoes</h3>
		<img className="alignright" src="assets/img/shoes.png" alt="A rock climbing shoe" />
		...
		<h3>Belay Device</h3>
		<img className="alignright" src="assets/img/belay-device.png" alt="An ATC-style belay device" />
		...
		<img className="alignright" src="assets/img/carabiners.png" alt="A chalk bag and a carabiner" />
		...
		<h3>Helmet</h3>
		<img className="alignright" src="assets/img/helmet.png" alt="A climbing helmet" />
