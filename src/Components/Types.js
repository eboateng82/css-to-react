...
<div className="wrapper">
	...
	<div className="mystyle" >
	    <ul Style={{listStyleType: none, margin: '0', padding:'0'}, {float : right}}>
			...
			<li><Link className="sidebar" to="/">Types of Climbing</Link></li>
	...
	<div className="main">
		<h2>Types of Climbing</h2>
		<h3>Indoor verses Outdoor</h3>
		<img className="alignleft" src="assets/img/indoor-climbing.jpg" alt="A woman climbing indoors"/>
