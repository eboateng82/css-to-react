	...
	<div id="mystyle" >
     ...
     <div id="main">
	   <h2>Equipment</h2>
		...
		<h3>Harness</h3>
		<img class="alignright" src="assets/img/emptyharness.jpg" alt="A rock climbing harness" />
		...
		<h3>Shoes</h3>
		<img class="alignright" src="assets/img/shoes.png" alt="A rock climbing shoe" />
		...
		<h3>Belay Device</h3>
		<img class="alignright" src="assets/img/belay-device.png" alt="An ATC-style belay device" />
		...
		<img class="alignright" src="assets/img/carabiners.png" alt="A chalk bag and a carabiner" />
		...
		<h3>Helmet</h3>
		<img class="alignright" src="assets/img/helmet.png" alt="A climbing helmet" />
